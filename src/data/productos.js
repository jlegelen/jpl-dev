export const productos = [
  {
    slug: "sitios-web",
    categoria: "Web / Presencia digital",
  ...
  {
    slug: "reservas",
    categoria: "Reservas / Turnos",
    nombre: "Sistema de Reservas",
    resumen:
      "Calendario, turnos, usuarios, panel administrativo y notificaciones.",
    descripcion:
  ...
  {
    slug: "presupuestos",
    categoria: "Ventas / Cotizaciones",
    nombre: "Sistema de Presupuestos",
    resumen:
      "Creación de presupuestos profesionales con PDF, clientes y envío por WhatsApp.",
    descripcion:
    ...
    imagenes: [
      "/img/presupuestos-1.png",
      "/img/presupuestos-2.png",
      "/img/presupuestos-3.png",
      "/img/presupuestos-4.png",
      "/img/presupuestos-5.png",
    ],
  },

  {
    slug: "ecommerce",
    categoria: "Tienda online / Ventas",
    nombre: "Ecommerce",
    resumen:
      "Tienda online con catálogo, detalle de productos, carrito y experiencia de compra moderna.",
    descripcion:
